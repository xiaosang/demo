...
class Mailer
{
     ...
     * @return bool
     */
    public static function sendMail($user_mail, $content, $title) {
        ...
        self::$mail->Host       = 'smtp.qq.com'; //SMTP服务器 以126邮箱为例子 
        ...
        self::$mail->Username   = '1062604184@qq.com';  //你的邮箱 
        self::$mail->Password   = 'CAONIDAYEDEDAN@0';  //你的密码 
        self::$mail->Subject    = '测试邮件'; //邮件标题  
        self::$mail->From       = '1062604184@qq.com';  //发件人地址（也就是你的邮箱）
